...
public class OrderEvent {
    ...
    public static class Created {
        ...
        @Builder
        private Created(Long orderId, Long userId, Long userCouponId,
    ...
    public static class Completed {
        ...
        @Builder
        private Completed(Long paymentId, Long orderId, Long userId, Long userCouponId,
                          long totalPrice, long discountPrice, List<OrderProduct> orderProducts) {
    ...
    public static class CompleteFailed {
        ...
        @Builder
        private CompleteFailed(Long paymentId, Long orderId, Long userId, Long userCouponId,
                               long totalPrice, long discountPrice, List<OrderProduct> orderProducts) {
            this.paymentId = paymentId;
            this.orderId = orderId;
            this.userId = userId;
    ...
    public static class PaymentWaited {
        ...
        @Builder
        private PaymentWaited(Long orderId, Long userId, Long userCouponId,
                              long totalPrice, long discountPrice, List<OrderProduct> orderProducts) {
            this.orderId = orderId;
            this.userId = userId;
            this.userCouponId = userCouponId;
    ...
    public static class Failed {
        ...
        @Builder
        private Failed(Long orderId, Long userId, Long userCouponId,
                       long totalPrice, long discountPrice,
                       List<OrderProduct> orderProducts, OrderProcesses processes) {
            this.orderId = orderId;
            this.userId = userId;
            this.userCouponId = userCouponId;
            this.totalPrice = totalPrice;
    ...
    public static class OrderProduct {
        ...
        public static OrderProduct of(com.github.gokid96.e_commerce.order.domain.OrderProduct orderProduct) {
