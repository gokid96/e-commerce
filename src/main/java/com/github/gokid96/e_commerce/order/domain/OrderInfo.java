...
public class OrderInfo {
    ...
    public static class Completed {
        ...
        @Builder
        private Completed(Long orderId, Long userId, Long userCouponId, OrderStatus orderStatus,
                          long totalPrice, long discountPrice, LocalDateTime completedAt) {
            this.orderId = orderId;
            this.userId = userId;
            this.userCouponId = userCouponId;
        ...
        public static Completed of(com.github.gokid96.e_commerce.order.domain.Order order) {
