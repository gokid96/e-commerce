...
public class StockEvent {
    ...
    public static class Deducted {
        ...
        @Builder
        private Deducted(Long orderId, Long userId, Long userCouponId,
    ...
    public static class DeductFailed {
        ...
        @Builder
        private DeductFailed(Long orderId, Long userId, Long userCouponId,
    ...
    public static class Restored {
        ...
        @Builder
        private Restored(Long orderId, Long userId, Long userCouponId,
                         long totalPrice, long discountPrice) {
            this.orderId = orderId;
            this.userId = userId;
            this.userCouponId = userCouponId;
