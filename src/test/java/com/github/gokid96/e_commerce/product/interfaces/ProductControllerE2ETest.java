...
class ProductControllerE2ETest extends E2EControllerTestSupport {
    ...
    void getProducts() {
        ...
        Stock stock1 = stockRepository.save(Stock.create(product1.getId(), 100));
        Stock stock2 = stockRepository.save(Stock.create(product2.getId(), 200));
        ...
        client.get()
                ...
                .jsonPath("$.data.products[0].stock").isEqualTo(stock1.getQuantity())
                .jsonPath("$.data.products[1].id").isEqualTo(product2.getId().intValue())
                .jsonPath("$.data.products[1].price").isEqualTo(200_000)
                .jsonPath("$.data.products[1].stock").isEqualTo(stock2.getQuantity());
    }
    ...
    void getPopularProducts() {
        ...
        Stock stock1 = stockRepository.save(Stock.create(product1.getId(), 1));
        Stock stock2 = stockRepository.save(Stock.create(product2.getId(), 2));
        Stock stock3 = stockRepository.save(Stock.create(product3.getId(), 3));
        Stock stock4 = stockRepository.save(Stock.create(product4.getId(), 4));
        Stock stock5 = stockRepository.save(Stock.create(product5.getId(), 5));
        ...
        client.get()
                ...
                .jsonPath("$.data.products[0].stock").isEqualTo(stock5.getQuantity())
                ...
                .jsonPath("$.data.products[4].stock").isEqualTo(stock1.getQuantity());
    }
}
